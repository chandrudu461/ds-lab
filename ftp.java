...
System.out.println("n Enter Username:\r");
...
static void read() {
try {
BufferedReader br = new BufferedReader(new InputStreamReader(System.in)); System.out.println("Enter Filename n");
String filename = br.readLine();
outstream.print("PASV"+"\r\n");
String s=ipstream.readLine(); 
